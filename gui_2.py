...
def batting1_buttons(player_ch, b1, b2, b3, b4, b5, b6):
    ...
    if player_ch == comp_ch:
        ...
        Label(player_batting1_frame, text="Player's\nScore : " + str(score1), font=("Arial", 25),
              bg='light blue').place(x=700, y=100)
        Label(player_batting1_frame, text="Computer has to score " + str(score1 + 1) + " runs to win",
              font=("Arial", 25), bg='light blue').place(x=20, y=394)
        Button(player_batting1_frame, text='Continue', bg='light blue', font=("Arial", 25),
               command=show_player_bowling2_buttons).place(x=700, y=320)
        ...
        if player_ch == 6:
            ...
            pygame.mixer.music.play()
    Label(player_batting1_frame, text="Player's\nScore : " + str(score1), font=("Arial", 25), bg='light blue').place(
        x=700, y=90)
...
def bowling1_button(player_ch, b1, b2, b3, b4, b5, b6):
    ...
    if player_ch == comp_ch:
        ...
        Label(player_bowling1_frame, text="Computer's\nScore : " + str(score1), font=("Arial", 25),
              bg='light blue').place(x=700, y=90)
        Label(player_bowling1_frame, text="Player has to score " + str(score1 + 1) + " runs to win", font=("Arial", 25),
              bg='light blue').place(x=20, y=394)
        Button(player_bowling1_frame, text='Continue', bg='light blue', font=("Arial", 25),
               command=show_player_batting2_buttons).place(x=700, y=320)
        pygame.mixer.music.load("out.mp3")
        pygame.mixer.music.play()
        return
    else:
...
def batting2_buttons(player_ch, b1, b2, b3, b4, b5, b6):
    ...
    c_im.place(x=370, y=138)
    global score1
    Label(player_batting2_frame, text="Target : " + str(score1 + 1), font=("Arial", 25), bg='light blue').place(x=700,
                                                                                                                y=210)
    global score2
    if player_ch != comp_ch:
        score2 += player_ch
        if score2 <= score1:
            ...
            b5['state'] = DISABLED
            b6['state'] = DISABLED
            Label(player_batting2_frame, text="Player's\nScore : " + str(score2), font=("Arial", 25),
                  bg='light blue').place(x=700, y=90)
            Label(player_batting2_frame, text="Player has won the match", font=("Arial", 25), bg='light blue').place(
                x=20, y=394)
    ...
    if player_ch == comp_ch:
        ...
        if score2 < score1:
            Label(player_batting2_frame, text="Player has lost the match by " + str(score1 - score2) + " runs",
                  font=("Arial", 25), bg='light blue').place(x=20, y=394)
        if score2 == score1:
        ...
        Label(player_batting2_frame, text="Player's\nScore : " + str(score2), font=("Arial", 25),
              bg='light blue').place(x=700, y=90)
        pygame.mixer.music.load("out.mp3")
    Label(player_batting2_frame, text="Player's\nScore : " + str(score2), font=("Arial", 25), bg='light blue').place(
        x=700, y=90)
    return
...
def bowling2_buttons(player_ch, b1, b2, b3, b4, b5, b6):
    ...
    c_im.place(x=370, y=138)
    global score1
    Label(player_bowling2_frame, text="Target : " + str(score1 + 1), font=("Arial", 25), bg='light blue').place(x=700,
                                                                                                                y=210)
    global score2
    if player_ch != comp_ch:
        score2 += comp_ch
        if score2 <= score1:
            ...
            b5['state'] = DISABLED
            b6['state'] = DISABLED
            Label(player_bowling2_frame, text="Computer has won the match", font=("Arial", 25), bg='light blue').place(
                x=20, y=394)
            pygame.mixer.music.load("victory.mp3")
            pygame.mixer.music.play()
    if player_ch == comp_ch:
        ...
        pygame.mixer.music.load("out.mp3")
        if score2 < score1:
            Label(player_bowling2_frame, text="Computer has lost the match by " + str(score1 - score2) + " runs",
                  font=("Arial", 25), bg='light blue').place(x=20, y=394)
            pygame.mixer.music.load("victory.mp3")
            pygame.mixer.music.play()
        if score2 == score1:
...
def head_button(hb, tb):
    ...
    if outcome == 'head':
        ...
        Button(play_frame, text='Take decision', bg='light blue', font=("Arial", 20), command=show_player_tw).place(
            x=350, y=210)
        winner='Player'
    else:
...
def toss(b1):
    ...
    if caller == 'Computer':
        ...
        Label(play_frame, text="Computer's choice is " + comp_ch, bg='light blue', font=("Arial", 20)).place(x=400,
                                                                                                             y=90)
        Label(play_frame, text="Outcome of the toss : " + outcome, bg='light blue', font=("Arial", 20)).place(x=20,
                                                                                                              y=150)
        if comp_ch == outcome:
            Label(play_frame, text="Computer has won the toss", bg='light blue', font=("Arial", 20)).place(x=420, y=150)
        else:
...
def setup_player_tw():
    ...
    bgl.image = img
    bat_b = Button(player_tw_frame, text='Batting', font=('Arial', 30), bg='light blue',
                   command=show_player_batting1_buttons)
    bat_b.place(x=270, y=90)
    ball_b = Button(player_tw_frame, text='Bowling', font=('Arial', 30), bg='light blue',
                    command=show_player_bowling1_buttons)
